    ...
    public class ActionMenuService : IActionMenuService
    {
        ...
        private class ActionMenu : IActionMenu
        {
            ...
            public Task Show(object sender)
            {
                ...
                {
                    (sender as UIBarButtonItem).Valid(x => sheet.PopoverPresentationController.BarButtonItem = x);
                    (sender as UIView).Valid(x => sheet.PopoverPresentationController.SourceView = x);
